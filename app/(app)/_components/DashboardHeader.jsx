// =====================================================================
// app/(app)/_components/DashboardHeader.jsx
// ---------------------------------------------------------------------
// Top header compartido por las pantallas del route group (app).
// Pinta:
...
//
// Vive en _components/ (prefijo "_") → privado, no es ruta.
//
...
export default function DashboardHeader() {
  ...
  return (
    ...
    <View
      className="bg-white flex-row items-center justify-between px-4 pb-3 border-b border-slate-100"
