...
// Chrome compartido del route group (app). El detalle usa el
...
// Path: este archivo vive en `app/(app)/announcements/[kind]/`, así que
// para llegar a `app/(app)/_components/` hay que subir 2 niveles
// (`announcements/[kind]/` → `announcements/` → `(app)/`).
