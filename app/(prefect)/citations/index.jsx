// =====================================================================
// app/(prefect)/(tabs)/citations.jsx
// ---------------------------------------------------------------------
// Ruta "/citations" del tab "Citatorios" del prefecto.
//
// Wrapper delgado que delega la UI a CitationsListScreen.
// El prefecto ve TODOS los citatorios de la escuela + tab "Mis Citatorios".
// =====================================================================
...
export default function PrefectCitationsScreen() {
  ...
  // Prefect services for the modal.
  ...
  const createPrefectCitation = useCallback(async (payload) => {
    return createCitation(payload);
  }, []);

  // Handlers.
  const handleNavigateToDetail = useCallback(
    (id) => router.push(`/(prefect)/citations/${id}`),
    [router],
  );
  ...
  return (
    <>
      <CitationsListScreen
        ...
        loadMore={loadMore}
        school={school}
        staffMember={dashboardData?.prefect}
      ...
      <GenerateCitationModal
        ...
        createCitationFn={createPrefectCitation}
