// =====================================================================
// app/(prefect)/citations/[id].jsx
// ---------------------------------------------------------------------
// Pantalla de DETALLE de un citatorio del prefecto.
//
// Ruta: /citations/:id
//
...
// =====================================================================
// ACTION_MAP — acciones del prefecto por status del citatorio.
// =====================================================================
// El prefecto solo puede: Editar, Reagendar, Eliminar.
...
// =====================================================================
export default function PrefectCitationDetail() {
  ...
  const fetchDetail = useCallback(async () => {
    ...
    try {
      ...
      console.error('[PrefectCitationDetail] unexpected error:', err);
  ...
  return (
    <View className="flex-1 bg-[#F8FAFC]">
      ...
      <EditCitationModal
        ...
        fetchGroupsFn={async () => {
          const { getGroups } = await import('@/src/services/prefectService');
