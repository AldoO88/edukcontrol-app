...
// ---------------------------------------------------------------------
// Ruta "/reports" del tab "Reportes" del prefecto.
// CRUD de reportes de conducta. El prefecto es el ÚNICO rol que
// genera conduct reports (create).
// =====================================================================
...
import GenerateConductReportModal from '@/app/(teacher)/_components/GenerateConductReportModal';
...
// =====================================================================
export default function PrefectReportsScreen() {
  ...
  // ============================================================
  // ADAPTER FUNCTIONS (prefect → modal interface)
  // ============================================================
  ...
  const createPrefectConductLog = useCallback(async (payload) => {
  ...
  const renderLog = useCallback(({ item }) => {
    ...
    return (
      <Pressable
        onPress={() => router.push(`/(prefect)/reports/${item._id}`)}
  ...
  return (
    <>
      ...
      <GenerateConductReportModal
        ...
        createConductLogFn={createPrefectConductLog}
