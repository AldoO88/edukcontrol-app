...
//   - Prefecto: solo lectura (no puede cancelar ni eliminar)
// =====================================================================
...
// =====================================================================
export default function PrefectReportDetail() {
  ...
  const fetchDetail = useCallback(async () => {
    ...
    try {
      ...
      console.error('[PrefectReportDetail] unexpected error:', err);
