...
// ---------------------------------------------------------------------
// Ruta "/profile" del tab "Perfil" del prefecto.
// Perfil personal con información del prefecto, seguridad y cerrar sesión.
// =====================================================================
...
// Hook del dashboard del prefecto (datos de la escuela).
...
// =====================================================================
export default function PrefectProfileScreen() {
  ...
  const prefectName = dashboardData?.prefect?.name || user?.name || 'Prefecto';
  const prefectLastName = dashboardData?.prefect?.last_name || user?.last_name || '';
  const fullName = `${prefectLastName} ${prefectName}`.trim() || prefectName;
  const roleLabel = 'Prefectura';
      ...
      >
          ...
          >
            <View className="flex-row items-center py-1.5">
              ...
              <Text className="ml-3" style={{ fontSize: 13, fontWeight: '600', color: '#334155' }}>
                Tel: {dashboardData?.prefect?.phoneNumber || user?.phoneNumber || '—'}
              </Text>
            </View>
            ...
            <View className="flex-row items-center py-1.5">
              ...
              <Text className="ml-3" style={{ fontSize: 13, fontWeight: '600', color: '#334155' }}>
                {dashboardData?.prefect?.email || user?.email || '—'}
              </Text>
            </View>
          </View>
        ...
        >
          <ProfileRow
            ...
            onPress={() => router.push('/(prefect)/(tabs)/profile/change-password')}
          />
        </View>
