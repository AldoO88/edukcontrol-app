// =====================================================================
// app/(prefect)/(tabs)/teachers.jsx
// ---------------------------------------------------------------------
// Pantalla de Maestros del prefecto. Muestra la lista de todos los
...
import { getAllTeachers } from '@/src/services/prefectService';

export default function PrefectTeachersScreen() {
  ...
  const renderTeacher = useCallback(
    ({ item }) => {
      ...
      return (
        <Pressable
          onPress={() => router.push(`/(prefect)/teachers/${item._id}`)}
