// =====================================================================
// app/(prefect)/(tabs)/groups.jsx
// ---------------------------------------------------------------------
// Pantalla de Grupos del prefecto. Muestra la lista de todos los
...
import { getGroupsSummary } from '@/src/services/prefectService';

// =====================================================================
// COMPONENTE PRINCIPAL
// =====================================================================
export default function PrefectGroupsScreen() {
  ...
  const renderGroup = useCallback(
    ({ item }) => {
      ...
      return (
        <Pressable
          onPress={() => router.push(`/(prefect)/groups/${item._id}`)}
