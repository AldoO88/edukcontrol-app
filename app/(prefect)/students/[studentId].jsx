// =====================================================================
// app/(prefect)/students/[studentId].jsx
// ---------------------------------------------------------------------
// Ficha completa del alumno. Muestra datos personales, contacto,
// tutor legal, salud, e historial de citatorios y reportes.
// =====================================================================
...
import { getStudentById, getConductLogs, getCitations, getConductConfig } from '@/src/services/prefectService';
import TrabajoSocialModal from '@/src/components/TrabajoSocialModal';
import CitationsModal from '@/app/(prefect)/_components/CitationsModal';
import ConductModal from '@/app/(prefect)/_components/ConductModal';
    ...
    <View className="flex-1 bg-slate-50">
      ...
      >
        ...
        {/* ============================================================
            ...
            ============================================================ */}
        <Pressable
          onPress={() => setIsInclusionOpen(true)}
          accessibilityRole="button"
