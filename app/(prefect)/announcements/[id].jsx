// =====================================================================
// app/(prefect)/announcements/[id].jsx
// ---------------------------------------------------------------------
// Pantalla de DETALLE de un aviso del prefecto.
//
// Ruta: /announcements/:id
//
// El prefecto toca una card del feed → se navega acá con el _id.
...
// =====================================================================
export default function PrefectAnnouncementDetail() {
  ...
  const fetchDetail = useCallback(async () => {
    ...
    try {
      ...
      console.error('[PrefectAnnouncementDetail] unexpected error:', err);
  ...
  const handleSaveEdit = useCallback(async () => {
    ...
    try {
      ...
      console.error('[PrefectAnnouncementDetail] save error:', err);
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              console.error('[PrefectAnnouncementDetail] delete error:', err);
