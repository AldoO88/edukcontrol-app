// =====================================================================
// app/(director)/announcements/[id].jsx
// ---------------------------------------------------------------------
...
// =====================================================================
export default function DirectorAnnouncementDetail() {
  ...
  const fetchDetail = useCallback(async () => {
    ...
    try {
      ...
      console.error('[DirectorAnnouncementDetail] unexpected error:', err);
  ...
  const handleSaveEdit = useCallback(async () => {
    ...
    try {
      ...
      console.error('[DirectorAnnouncementDetail] save error:', err);
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              console.error('[DirectorAnnouncementDetail] delete error:', err);
