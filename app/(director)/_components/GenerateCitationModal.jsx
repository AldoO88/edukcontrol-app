...
//   - createCitationFn: fn(payload) => Promise<{success, data}> — creación (default: createCitation).
...
import { getMyGroups, createCitation } from '../../../src/services/directorService';
...
const GenerateCitationModal = ({
  ...
  const handleEmit = async () => {
    ...
    const createFn = createCitationFn || createCitation;
