// =====================================================================
// app/(director)/(tabs)/profile/index.jsx
// ---------------------------------------------------------------------
// Ruta "/profile" del tab "Perfil" del director.
// Perfil personal con información del director, seguridad y cerrar sesión.
// =====================================================================
...
export default function DirectorProfileScreen() {
  ...
  const directorName = dashboardData?.director?.name || user?.name || 'Director';
  const directorLastName = dashboardData?.director?.last_name || user?.last_name || '';
  const fullName = `${directorLastName} ${directorName}`.trim() || directorName;
  const roleLabel = 'Dirección';
      ...
      >
        ...
        >
          <View className="items-center pt-6 pb-4">
            ...
            >
              <Text
                style={{ fontSize: 32, fontWeight: '800', color: '#4338CA' }}
              >
                {initials}
              </Text>
            </View>
          ...
          >
            <View className="flex-row items-center py-1.5">
              ...
              <Text className="ml-3" style={{ fontSize: 13, fontWeight: '600', color: '#334155' }}>
                Tel: {dashboardData?.director?.phoneNumber || user?.phoneNumber || '—'}
              </Text>
            </View>
            ...
            <View className="flex-row items-center py-1.5">
              ...
              <Text className="ml-3" style={{ fontSize: 13, fontWeight: '600', color: '#334155' }}>
                {dashboardData?.director?.email || user?.email || '—'}
              </Text>
            </View>
          </View>
        ...
        >
          <ProfileRow
            ...
            onPress={() => router.push('/(director)/(tabs)/profile/change-password')}
          />
        </View>
