...
import EditCitationModal from '@/app/(director)/_components/EditCitationModal';
import RescheduleModal from '@/app/(director)/_components/RescheduleModal';
...
// =====================================================================
export default function DirectorCitationDetail() {
  ...
  const fetchDetail = useCallback(async () => {
    ...
    try {
      ...
      console.error('[DirectorCitationDetail] unexpected error:', err);
  ...
  return (
    <View className="flex-1 bg-[#F8FAFC]">
      ...
      <EditCitationModal
        ...
        fetchGroupsFn={async () => {
          const { getGroups } = await import('@/src/services/directorService');
