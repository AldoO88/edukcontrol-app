// =====================================================================
// app/(social-worker)/students/[studentId].jsx
// ---------------------------------------------------------------------
...
import { getConductConfig } from '@/src/services/prefectService';
import CitationsModal from '@/app/(social-worker)/_components/CitationsModal';
import ConductModal from '@/app/(social-worker)/_components/ConductModal';
...
export default function SocialWorkerStudentDetail() {
