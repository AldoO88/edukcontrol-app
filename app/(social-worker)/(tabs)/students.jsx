// =====================================================================
// app/(social-worker)/(tabs)/students.jsx
// ---------------------------------------------------------------------
// Pantalla de Búsqueda de Alumnos del trabajador social. Muestra una lista
...
export default function SocialWorkerStudentsScreen() {
  ...
  const renderStudent = useCallback(
    ({ item }) => (
      <Pressable
        onPress={() => router.push(`/(social-worker)/students/${item._id}`)}
