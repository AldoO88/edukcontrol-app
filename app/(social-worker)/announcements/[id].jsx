// =====================================================================
// app/(social-worker)/announcements/[id].jsx
// ---------------------------------------------------------------------
// Pantalla de DETALLE de un aviso del trabajador social.
//
// Ruta: /announcements/:id
//
// El trabajador social toca una card del feed → se navega acá con el _id.
...
//   - Título del aviso
//   - Card "De:" (sender + role)
//   - Card "Para:" (targetGroups o targetStudents o General)
//   - Card "Mensaje" (body completo)
//   - Read count (si está disponible)
//   - Meta info (Publicado / Expira)
//   - Botones Editar/Eliminar (solo si el usuario es el sender)
//
// Permisos (canEdit):
//   - Solo el sender del aviso puede editar/eliminar.
// =====================================================================
...
// =====================================================================
export default function SocialWorkerAnnouncementDetail() {
  ...
  const fetchDetail = useCallback(async () => {
    ...
    try {
      ...
      console.error('[SocialWorkerAnnouncementDetail] unexpected error:', err);
  ...
  // -----------------------------------------------------------------
  // PERMISOS — solo el sender puede editar/eliminar
  // -----------------------------------------------------------------
  const canEdit = useMemo(() => {
    if (!item || !user) return false;
    return item.sender?._id === user.id;
  }, [item, user]);
  ...
  const handleSaveEdit = useCallback(async () => {
    ...
    try {
      ...
      console.error('[SocialWorkerAnnouncementDetail] save error:', err);
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              console.error('[SocialWorkerAnnouncementDetail] delete error:', err);
  ...
  return (
    <View className="flex-1 bg-[#F8FAFC]">
      ...
      <View className="px-4 mt-2 mb-1">
        <Text className="text-xl font-bold text-slate-900">Detalle del Aviso</Text>
      </View>
      ...
      >
        ...
        {!isLoading && !error && item && (
          <View className="px-4 pt-2">
            ...
            {/* ========================================================
                BOTONES EDITAR / ELIMINAR (solo si canEdit)
                ======================================================== */}
            {canEdit && (
