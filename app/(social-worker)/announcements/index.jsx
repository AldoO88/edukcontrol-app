// =====================================================================
// app/(social-worker)/(tabs)/announcements.jsx
// ---------------------------------------------------------------------
...
// Tap en card → navega a detalle (/(social-worker)/announcements/:id).
// =====================================================================
...
// =====================================================================
export default function SocialWorkerAnnouncementsScreen() {
  ...
  const mapSocialWorkerGroup = useCallback((g) => ({
    id: g._id,
  ...
  const {
    ...
    mapGroupFn: mapSocialWorkerGroup,
    fetchStudentsFn: fetchSocialWorkerStudents,
    onPublished: refetch,
  });
  ...
  const renderAnnouncement = useCallback(({ item }) => {
    ...
    return (
      <Pressable
        onPress={() => router.push(`/(social-worker)/announcements/${item._id}`)}
