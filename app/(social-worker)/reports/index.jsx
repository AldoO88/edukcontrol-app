// =====================================================================
// app/(social-worker)/(tabs)/reports.jsx
// ---------------------------------------------------------------------
...
// =====================================================================
export default function SocialWorkerReportsScreen() {
  ...
  const createSocialWorkerConductLog = useCallback(async (payload) => {
  ...
  const renderLog = useCallback(({ item }) => {
    ...
    return (
      <Pressable
        onPress={() => router.push(`/(social-worker)/reports/${item._id}`)}
  ...
  return (
    <>
      ...
      <GenerateConductReportModal
        ...
        createConductLogFn={createSocialWorkerConductLog}
