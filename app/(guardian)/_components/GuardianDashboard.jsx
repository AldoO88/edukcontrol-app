...
export default function GuardianDashboard() {
  ...
  return (
    ...
    <View className="flex-1 bg-slate-50">
      ...
      {/* School info card fija (no scrollea). Fuera del ScrollView
