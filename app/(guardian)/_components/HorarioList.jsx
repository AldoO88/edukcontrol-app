// =====================================================================
// app/(guardian)/_components/HorarioList.jsx
// ---------------------------------------------------------------------
...
//                  { type: "receso", time }
//   - colorIndex: number (default 0). Índice para rotar el color de
//                 la cinta superior del card (border-t).
// =====================================================================
...
// BORDER_COLORS
// ---------------------------------------------------------------------
// Paleta de colores para la cinta superior del card del horario.
// Rota según el `colorIndex` que se reciba como prop, para que no
// todos los días se vean con el mismo azul.
// ---------------------------------------------------------------------
const BORDER_COLORS = [
  'border-t-sky-500',
  'border-t-rose-500',
...
// HorarioList
// ---------------------------------------------------------------------
const HorarioList = ({ day = 'LUN', schedule = [], colorIndex = 0 }) => {
  ...
  return (
    ...
    // - border-t-[5px]: cinta de color (rotativo según colorIndex).
    ...
    <View
      className={clsx(
        'bg-white rounded-2xl border border-slate-200 border-t-[5px] shadow-md overflow-hidden',
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* Textos: nombre completo + maestro + badge Taller. */}
              <View className="flex-1 min-w-0">
                <View className="flex-row items-center">
                  ...
                  {/* Badge "Taller" si es del grupo taller. */}
                  {slot.isTaller && (
                    <View className="ml-1 px-1.5 py-0.5 bg-purple-100 rounded">
