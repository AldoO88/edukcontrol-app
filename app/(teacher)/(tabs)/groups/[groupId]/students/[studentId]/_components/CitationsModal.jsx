// =====================================================================
// app/(teacher)/.../students/[studentId]/_components/CitationsModal.jsx
// ---------------------------------------------------------------------
// Modal bottom-sheet que muestra todos los citatorios del alumno en
// el expediente de tutoría. Réplica del patrón del prefect adaptada
// al route group del teacher.
// =====================================================================
...
// ---------------------------------------------------------------------
// CITATION_TYPE_STYLES / CITATION_STATUS_STYLES
// ---------------------------------------------------------------------
// Mismas constantes que el prefect (look visual consistente entre
// roles para el mismo dominio).
// ---------------------------------------------------------------------
...
const CitationsModal = ({ isVisible, onClose, citations }) => {
  // Filtra cancelados del contador y de la lista activa.
    ...
    >
      <View className="flex-1" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
        <Pressable
          className="flex-1"
          onPress={onClose}
          accessibilityLabel="Cerrar modal de citatorios"
        />
            ...
            <View className="flex-row items-center justify-between mt-2 mb-4">
              <View className="flex-row items-center flex-1">
                <View
                  ...
                  style={{ backgroundColor: '#FEF3C7', padding: 8, borderRadius: 12 }}
                >
              ...
              >
                {activeCitations.map((citation, idx) => {
                  ...
                  const scheduledDate = citation.scheduledDate
                    ? new Date(citation.scheduledDate).toLocaleDateString('es-MX', {
                        day: 'numeric',
                        month: 'short',
                        year: 'numeric',
                      })
