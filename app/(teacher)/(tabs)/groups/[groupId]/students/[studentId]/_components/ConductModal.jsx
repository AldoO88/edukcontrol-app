// =====================================================================
// app/(teacher)/.../students/[studentId]/_components/ConductModal.jsx
// ---------------------------------------------------------------------
// Modal bottom-sheet que muestra el score de conducta del alumno
// (barra de progreso 0-100) y el historial de reportes. Réplica del
// patrón del prefect adaptada al route group del teacher.
// =====================================================================
    ...
    >
      <View className="flex-1" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
        <Pressable
          className="flex-1"
          onPress={onClose}
          accessibilityLabel="Cerrar modal de conducta"
        />
        ...
        <View className="bg-white rounded-t-3xl" style={{ maxHeight: '85%' }}>
          ...
          >
            ...
            {/* Score Card. */}
            <View
              className="bg-white rounded-2xl p-4 mb-4 border border-slate-100 items-center"
              style={{
                shadowColor: '#0F172A',
                shadowOpacity: 0.04,
                shadowRadius: 6,
            ...
            >
              ...
              <View
                ...
                style={{ height: 8, backgroundColor: '#F1F5F9', borderRadius: 4 }}
              >
                <View
                  style={{
                    width: `${percentage}%`,
                ...
                <View className="mb-4">
                  ...
                  <View className="flex-row" style={{ gap: 8 }}>
                    ...
                    >
                      ...
                      <Text
                        style={{ fontSize: 28, fontWeight: '800', color: '#DC2626' }}
                      >
                        {demeritsCount}
                      </Text>
                      <Text
                    ...
                    >
                      ...
                      <Text
                        style={{ fontSize: 28, fontWeight: '800', color: '#059669' }}
                      >
                        {meritsCount}
                      </Text>
                      <Text
                  ...
                  <View className="items-center mt-2">
                    <Text
                      style={{
                        fontSize: 11,
                        fontWeight: '600',
                        color: netPoints >= 0 ? '#059669' : '#DC2626',
                      }}
                    >
            ...
            <Text
              className="text-slate-500 mt-2 mb-2"
              style={{
                fontSize: 11,
                fontWeight: '700',
                textTransform: 'uppercase',
                    ...
                    >
                      <View
                        ...
                        style={{
                          ...
                          height: 28,
                          borderRadius: 14,
                          backgroundColor: isMerit ? '#D1FAE5' : '#FEF2F2',
                        }}
                      >
                        {isMerit ? (
                      ...
                      {log.points_impact != null && (
                        <Text
                          className={`text-xs font-bold ml-2 ${
                            log.eventType === 'demerit' ? 'text-rose-600' : 'text-emerald-600'
                          }`}
                        >
